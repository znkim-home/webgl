...
class ScreenShaderProcess extends ShaderProcess_1.default {
    constructor(gl, shader, globalOptions, camera, frameBufferObjs, sun) {
    ...
    preprocess() {
        ...
        this.screens = [];
        this.mainScreen = new Screen_js_1.default([[0, 0], [1, 0], [1, 1], [0, 1]], { reverse: true, forDebug: false, textureLocation: shaderInfo.uniformLocations.mainTexture });
        this.albedoScreen = new Screen_js_1.default([[0.85, 0.85], [1, 0.85], [1, 1], [0.85, 1]], { reverse: true, forDebug: true, textureLocation: shaderInfo.uniformLocations.albedoTexture });
        this.selectionScreen = new Screen_js_1.default([[0.85, 0.7], [1, 0.7], [1, 0.85], [0.85, 0.85]], { reverse: true, forDebug: true, textureLocation: shaderInfo.uniformLocations.selectionTexture });
        this.normalScreen = new Screen_js_1.default([[0.85, 0.55], [1, 0.55], [1, 0.7], [0.85, 0.7]], { reverse: true, forDebug: true, textureLocation: shaderInfo.uniformLocations.normalTexture });
        this.depthScreen = new Screen_js_1.default([[0.85, 0.40], [1, 0.40], [1, 0.55], [0.85, 0.55]], { reverse: true, forDebug: true, textureLocation: shaderInfo.uniformLocations.depthTexture });
        this.lightMapDepthScreen = new Screen_js_1.default([[0.92, 0.25], [1, 0.25], [1, 0.40], [0.92, 0.40]], { reverse: true, forDebug: true, textureLocation: shaderInfo.uniformLocations.lightMapTexture });
    ...
    process() {
        ...
        gl_matrix_1.mat4.perspective(projectionMatrix, fovy, globalOptions.aspect, globalOptions.near, globalOptions.far);
