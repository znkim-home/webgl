...
class DefaultShaderProcess extends ShaderProcess {
  ...
  frameBufferObjs: any;
  camera: any;
  constructor(gl: WebGL2RenderingContext | WebGLRenderingContext, shader: any, camera: any, frameBufferObjs: any, renderableList: RenderableListInterface) {
    super(gl, shader);
    this.camera = camera;
