...
class WebGL {
    ...
    startRender() {
        ...
        this.shaderProcesses.push(new DefaultShaderProcess_js_1.default(gl, this.defaultShader, this.globalOptions, this.camera, this.defaultFrameBufferObjs, this.renderableObjectList));
        this.shaderProcesses.push(new LightMapShaderProcess_js_1.default(gl, this.lightMapShader, this.globalOptions, this.camera, this.lightMapFrameBufferObjs, this.renderableObjectList, this.sun));
        this.shaderProcesses.push(new ScreenShaderProcess_js_1.default(gl, this.screenShader, this.globalOptions, this.camera, this.frameBufferObjs, this.sun));
