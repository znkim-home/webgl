...
class Rectangle extends Renderable_js_1.default {
    ...
    getBuffer(gl) {
        ...
        if (this.dirty === true) {
            ...
            let leftTriangle = new Triangle_js_1.default(rectanglePositions[0], rectanglePositions[1], rectanglePositions[2]);
            let rightTriangle = new Triangle_js_1.default(rectanglePositions[0], rectanglePositions[2], rectanglePositions[3]);
