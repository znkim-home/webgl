...
export default class Elipsoid extends Renderable {
    constructor(options) {
        super();
        this.init(options);
    }
    init(options) {
        this.triangles = [];
        this.verticalRadius = 1.0;
        this.horizontalRadius = 1.5;
        this.height = 3.0;
        this.density = 16;
        ...
        if (options === null || options === void 0 ? void 0 : options.position)
            this.position = vec3.set(this.position, options.position.x, options.position.y, options.position.z + this.verticalRadius);
    ...
    getBuffer(gl) {
        if (this.buffer === undefined || this.dirty === true) {
            ...
            this.coordinates = [];
            var equatorialRadius = 6378137.0; // equatorialRadius
            var polarRadius = 6356752.3142; // polarRadius
            let verticalRadius = polarRadius / 10000;
            let horizontalRadius = equatorialRadius / 10000;
            //let verticalRadius = this.verticalRadius;
            //let horizontalRadius = this.horizontalRadius;
            //let verticalRadius = 75;
            //let horizontalRadius = 100;
            ...
            //let radiusOffset = verticalRadius - Math.abs(horizontalRadius - verticalRadius);
