...
export default class WebGL {
    ...
    startRender() {
        ...
        if (!Renderable.globalOptions)
            Renderable.globalOptions = this.globalOptions;
    ...
    render(now) {
        ...
        fpsObject.frame = fpsObject.frames.reduce((a, b) => a + b) / fpsObject.frames.length;
