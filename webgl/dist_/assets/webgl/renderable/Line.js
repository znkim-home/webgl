...
export default class Line extends Renderable {
    ...
    render(gl, shaderInfo, renderOptions) {
        ...
        textureType = ((renderOptions === null || renderOptions === void 0 ? void 0 : renderOptions.textureType) !== undefined) ? renderOptions === null || renderOptions === void 0 ? void 0 : renderOptions.textureType : textureType;
