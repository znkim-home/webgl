...
export default class FrameBufferObject {
    ...
    init() {
        ...
        this.width = new Int32Array([((_d = this.options) === null || _d === void 0 ? void 0 : _d.width) ? this.options.width : canvas.width]);
        this.height = new Int32Array([((_e = this.options) === null || _e === void 0 ? void 0 : _e.height) ? this.options.height : canvas.height]);
